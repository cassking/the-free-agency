...
RSpec.describe Api::V1::CommentsController, type: :controller do
  let!(:player1) { Player.create(
                    ...
                    age: "29",height: "6'9",weight: "240",birth_city: "Washington, D.C.",
                    birth_country: "USA",position: "SF") }
  let!(:user1) { User.create(
                  email: 'pieday@yahoo.com',
                  username: 'ilovepie',
                  password: 'password' ) }
  let!(:comment1) { Comment.create(
                    user_id: user1.id, player_id: player1.id, body: 'This is a comment on Kevin Durant.' ) }
